...
def config():
    ...
    #Adjust!
    local_checkpoint_dir = "./ckpts_train"

    #Von mir - war nicht initialisiert für diffusion_modell
    perceptual_loss = int(os.getenv("perceptual_loss", 1))  # 1 for True, 0 for False
    ...
    sample_rate = int(os.getenv("sample_rate", 48000)) #for LRS3 16000
    ...
    # Experiment Configs
    batch_size = int(os.getenv("batch_size", 256)) #256 for more GPU
